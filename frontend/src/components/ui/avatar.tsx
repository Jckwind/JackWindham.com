...
export const Avatar = ({ src = Me.avatarURL, alt = Me.name, className, ...props }: Props) => {
  return (
...
export const AvatarContainer = ({ className, ...props }: Container_Props) => {
  return (
    <div
      className={clsx(
        className,
        'h-10 w-10 p-0.5 shadow-[0_0_2px_2px]',
